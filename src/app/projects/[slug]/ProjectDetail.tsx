  ...
  return (
    <article className="min-h-screen bg-black px-[clamp(1rem,4vw,1.5rem)] pb-[clamp(5rem,10vw,7rem)] pt-6">
      ...
      <div className="mx-auto mt-[clamp(4rem,10vw,5rem)] max-w-7xl">
        ...
        <div className="mt-[clamp(4rem,10vw,5rem)] grid gap-10 lg:grid-cols-[minmax(12rem,16rem)_minmax(0,1fr)]">
          ...
          <div className="space-y-12 text-zinc-300">
            ...
            <section id="architecture" className="scroll-mt-28">
              <h2 className="text-[clamp(1.875rem,4vw,2.25rem)] font-semibold text-zinc-50">Architecture</h2>
            ...
            <section id="links" className="scroll-mt-28">
              <h2 className="text-[clamp(1.875rem,4vw,2.25rem)] font-semibold text-zinc-50">Links</h2>
